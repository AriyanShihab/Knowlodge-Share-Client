  ...
  const googlePopupLogin = () => {
    singUpwithGooglePopup()
      .then((result) => {
        ...
        toast.success("sigin up using google complite", { autoClose: 1000 });
  ...
  return (
    <div className="bg-gray-900  py-20">
      <div className="w-full mx-auto max-w-md p-8 space-y-3 rounded-xl bg-gray-800 text-gray-100 ">
        <h1 className="text-2xl font-bold text-center text-[#f66962]">Login</h1>
        <form
        ...
        >
          ...
          <button className="block w-full p-3 text-center rounded-sm text-gray-900 bg-[#f66962] font-bold">
            Sign in
          </button>
        </form>
        ...
        <p className="text-xs text-center sm:px-6 text-gray-400">
          ...
          <Link
            ...
            to="/signup"
            className="underline text-gray-100 ml-1"
          >
            Sign up
          </Link>
        </p>
